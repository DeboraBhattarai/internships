 ...
 */
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo web_root; ?>">Student's Intern</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <?php if (!isset($_SESSION['APPLICANTID'])) { ?>
             ...
             <li class="nav-item cta mr-md-2"><a href="<?php echo web_root; ?>admin/" class="nav-link">Post a intern</a></li>
             <?php }else{ ?>

              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'applicant/';?>"><i class="fa fa-user"></i> Hi, <?php echo $appl->FNAME. ' '.$appl->LNAME ;?></a></li>

              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'logout.php';?>"><i class="fa fa-user"></i> Logout</a></li>
             <?php } ?> 
	          <li class="nav-item cta cta-colored"><a href="<?php echo web_root; ?>" class="nav-link">Want a intern</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">44600, Gokarneshowr, Kathmandu Nepal</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+977 9844092892</span></a></li>
