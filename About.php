 ...
 <section class="ftco-about d-md-flex">
        ...
        <div class="heading-section ftco-animate ">
          <h2 class="mb-4"><span>We Are The Internship Portal Agency</span></h2>
        </div>
        <div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(<?php echo web_root; ?>plugins/jobportal/images/1.jpg)">
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4"> Hi! my name is Nishant Maharhan. I am an employee as UI Designer in this company.</p>
                    <p class="name">Nishant Maharjan</p>
